...
4. 在“连接”或“本机代理设置”中选择代理模式：“规则”“全局”或“直连”。
5. 使用“规则”或“全局”时，在“设置”中配置服务器，并通过测速结果选择节点；使用“直连”时可以跳过这一步。
6. 如需修改监听地址、端口、UDP 或网络接入方式，打开“本机代理设置”。
7. 回到“连接”打开本地代理开关。
8. 可以启用“系统代理”，让遵循 macOS 代理设置的应用自动使用本地端点；未启用时，在目标应用中手动填写“设置”里显示的端点。
...
应用内置的是不含真实账号的安全示例配置。“规则”和“全局”模式需要在“设置”中填写自己的连接参数，或使用高级 JSON / 完整配置导入功能；如果只需要保留本地端点并直接连接，可以切换到“直连”模式，无需服务器配置或节点。
