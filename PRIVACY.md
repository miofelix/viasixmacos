...
- 服务器配置 `server.json`、本机代理设置 `local-proxy.json`、完整配置兼容文件 `template.json` 及生成的 `config.json`
- ViaSix 管理的第三方运行组件
...
- CloudflareSpeedTest 和 Xray-core 的 GitHub API 与 Releases，用于查询并下载最新正式版本组件
